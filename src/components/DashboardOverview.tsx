...
export default function DashboardOverview({
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-8">
      ...
      {/* Bento-Styled Primary Segment Tabbed Selector Navigation Row */}
      <div className="flex flex-col gap-6 mt-4">
        <div className="bg-slate-100 p-2 rounded-2xl border-2 border-slate-900 inline-flex flex-wrap gap-2 md:gap-3">
          {tabList.map((tab) => {
